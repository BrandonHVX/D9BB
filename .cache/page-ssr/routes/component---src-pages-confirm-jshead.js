exports.id = "component---src-pages-confirm-jshead";
exports.ids = ["component---src-pages-confirm-jshead"];
exports.modules = {
    ...
    if (false) {} else {
      inFlightPromise = Promise.all([this.loadAppData(), this.loadPageDataJson(pagePath)]).then(allData => {
        ...
        return Promise.all(dedupedSliceNames.map(sliceName => this.loadSliceDataJson(sliceName))).then(slicesData => {
          ...
          const componentChunkPromises = Promise.all([this.loadComponent(componentChunkName), this.loadComponent(componentChunkName, `head`), Promise.all(slices.map(loadSlice))]).then(components => {
            ...
            if (finalResult.status !== PageResourceStatus.Error) {
              ...
              pageResources = toPageResources(pageData, rootComponent, headComponent);
            }
...
}, siteTitle), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_nav_link__WEBPACK_IMPORTED_MODULE_2__["default"], {
  to: "/decisions"
}, "Make Decisions"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_nav_link__WEBPACK_IMPORTED_MODULE_2__["default"], {
  to: "/about"
}, "About"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_nav_link__WEBPACK_IMPORTED_MODULE_2__["default"], {
  to: "/sign-up"
}, "Sign Up")));
Header.propTypes = {
...
const NavLink = ({
  children,
  ...props
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, Object.assign({}, props, {
  style: linkStyles,
...
/***/ "./src/pages/confirm.js?export=head":
/*!******************************************!*\
  !*** ./src/pages/confirm.js?export=head ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (({
  location
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Are you sure you want to choose ", location.state.choice, "?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "No pressure, but this is ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("em", null, "really"), " important."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  style: choiceStyles,
  to: "/choice/",
  state: {
  ...
  replace: true
}, "Yes, I\u2019m sure."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  style: choiceStyles,
  to: "/decisions/"
...
"use strict";
module.exports = JSON.parse('{"data":{"site":{"siteMetadata":{"title":"Gatsby Demo Simple Authentication"}}}}');

/***/ })

};
;
//# sourceMappingURL=component---src-pages-confirm-jshead.js.map